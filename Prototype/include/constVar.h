...
enum DATA_TYPE_SET {DATA_CHUNK = 0, RECIPE_END, DATA_SEGMENT_END_FLAG, CHUNK_FP, FP_END}; 
...
enum SSL_CONNECTION_TYPE {IN_SERVERSIDE = 0, IN_CLIENTSIDE, IN_CLOUDSIDE};
...
enum PROTCOL_CODE_SET {CLIENT_UPLOAD_CHUNK = 0, CLIENT_UPLOAD_RECIPE_END,
    ...
    SESSION_KEY_INIT, SESSION_KEY_REPLY, EDGE_UPLOAD_FP, EDGE_UPLOAD_FP_END, 
    EDGE_UPLOAD_CHUNK, EDGE_UPLOAD_CHUNK_END, EDGE_LOGIN_UPLOAD, EDGE_LOGIN_DOWNLOAD, 
    CLOUD_FILE_NON_EXIST, CLOUD_LOGIN_RESPONSE};
...
enum IS_IN_EDGE {IN_EDGE = 0, IN_CLOUD = 1};

enum IS_EMPTY {ABSENT = 0};
