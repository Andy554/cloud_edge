...
void Ecall_GetEnclaveInfo(EnclaveInfo_t* info) {
    ...
    info->indeduptime = enclaveBaseObj_->_indeduptime;
    info->outdeduptime = enclaveBaseObj_->_outdeduptime;
    info->sftime = enclaveBaseObj_->_sftime;
    info->indeltatime = enclaveBaseObj_->_indeltatime;
    info->outdeltatime = enclaveBaseObj_->_outdeltatime;
    info->conI_Otime = enclaveBaseObj_->_conI_Otime;
    info->conupdatetime = enclaveBaseObj_->_conupdatetime;
    info->processtime = enclaveBaseObj_->_processtime;
    info->deltaprocesstime = enclaveBaseObj_->_deltaprocesstime;
    info->uniqueprocesstime = enclaveBaseObj_->_uniqueprocesstime;
    info->backup_unique = enclaveBaseObj_->backup_unique;
    info->backup_delta = enclaveBaseObj_->backup_delta;
    info->backup_indelta = enclaveBaseObj_->backup_indelta;
    info->backup_outdelta = enclaveBaseObj_->backup_outdelta;
    info->backup_delay_pop = enclaveBaseObj_->backup_delay_pop;
    info->backup_delay_push = enclaveBaseObj_->backup_delay_push;
    info->backup_total = info->indeduptime+info->outdeduptime+info->sftime+info->indeltatime+info->outdeltatime+info->processtime;
    info->backup_enclave_total = enclaveBaseObj_->backup_enclave_total;

    enclaveBaseObj_->_indeduptime = 0;
    enclaveBaseObj_->_outdeduptime = 0;
    enclaveBaseObj_->_sftime = 0;
    enclaveBaseObj_->_indeltatime = 0;
    enclaveBaseObj_->_outdeltatime = 0;
    enclaveBaseObj_->_conI_Otime = 0;
    enclaveBaseObj_->_conupdatetime = 0;
    enclaveBaseObj_->_delaytime = 0;
    enclaveBaseObj_->_delayupdatetime = 0;
    enclaveBaseObj_->_delayprocesstime = 0;
    enclaveBaseObj_->_processtime = 0;
    enclaveBaseObj_->_deltaprocesstime = 0;
    enclaveBaseObj_->_uniqueprocesstime = 0;
    enclaveBaseObj_->backup_indelta = 0;
    enclaveBaseObj_->backup_outdelta = 0;
    enclaveBaseObj_->backup_unique = 0;
    enclaveBaseObj_->backup_delay_pop = 0;
    enclaveBaseObj_->backup_delay_push = 0;
    enclaveBaseObj_->backup_enclave_total = 0;
#if (SGX_BREAKDOWN == 1)
